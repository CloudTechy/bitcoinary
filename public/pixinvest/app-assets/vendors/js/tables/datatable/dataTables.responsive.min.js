! function(e) {
    ...
    e.extend(s.prototype, {
        ...
        _columnsVisiblity: function(t) {
            var n, i, r = this.s.dt,
                ...
                d = 0;
            for (n = 0, i = a.length; n < i; n++) !0 === a[n] && (d += s[n].minWidth);
            var l = r.settings()[0].oScroll,
                c = l.sY || l.sX ? l.iBarWidth : 0,
                u = r.table().container().offsetWidth - c - d;
            for (n = 0, i = a.length; n < i; n++) s[n].control && (u -= s[n].minWidth);
            var h = !1;
            for (n = 0, i = o.length; n < i; n++) {
                var p = o[n].columnIdx;
                "-" === a[p] && !s[p].control && s[p].minWidth && (h || u - s[p].minWidth < 0 ? (h = !0, a[p] = !1) : a[p] = !0, u -= s[p].minWidth)
            }
            var f = !1;
            ...
            for (n = 0, i = s.length; n < i; n++) s[n].control && (a[n] = f), "not-visible" === a[n] && (a[n] = !1);
        ...
        _classLogic: function() {
            var t = this,
                ...
                a = function(e, i, r, a) {
                    ...
                    if (r) {
                        if ("max-" === r)
                            for (d = t._find(i).width, l = 0, c = n.length; l < c; l++) n[l].width <= d && o(e, n[l].name);
                        else if ("min-" === r)
                            for (d = t._find(i).width, l = 0, c = n.length; l < c; l++) n[l].width >= d && o(e, n[l].name);
                        else if ("not-" === r)
                            for (l = 0, c = n.length; l < c; l++) - 1 === n[l].name.indexOf(a) && o(e, n[l].name)
        ...
        _controlClass: function() {
            if ("inline" === this.c.details.type) {
                ...
                t.cells(null, function(e) {
                    ...
                    page: "current"
                }).nodes().to$().filter(".dtr-control").removeClass("dtr-control"), t.cells(null, i, {
                    page: "current"
        ...
        _detailsDisplay: function(t, n) {
            ...
            if (s && !1 !== s.type) {
                ...
                !0 !== o && !1 !== o || e(r.table().node()).triggerHandler("responsive-display.dt", [r, t, o, n])
            }
        },
        ...
        _resize: function(n) {
            ...
            for (i = 0, r = c.length; i < r; i++)
                if (!1 === h[i] && !c[i].never && !c[i].control && !1 == !o.column(i).visible()) {
                    p = !0;
                    break
                }
            e(o.table().node()).toggleClass("collapsed", p);
            var f = !1,
                m = 0;
            o.columns().eq(0).each(function(e, t) {
                !0 === h[t] && m++, (n || h[t] !== u[t]) && (f = !0, s._setColumnVis(e, h[t]))
            }), f && (this._redrawChildren(), e(o.table().node()).trigger("responsive-resize.dt", [o, this.s.current]), 0 === o.page.info().recordsDisplay && e("td", o.table().body()).eq(0).attr("colspan", m))
        },
        _resizeAuto: function() {
            ...
            if (this.c.auto && -1 !== e.inArray(!0, e.map(n, function(e) {
                ...
                h.insertBefore(t.table().node()), d.each(function(e) {
        ...
        _setColumnVis: function(t, n) {
            var i = this.s.dt,
                r = n ? "" : "none";
            e(i.column(t).header()).css("display", r), e(i.column(t).footer()).css("display", r), i.column(t).nodes().to$().css("display", r), e.isEmptyObject(o) || i.cells(null, t).indexes().each(function(e) {
                a(i, e.row, e.column)
            })
        },
            ...
            return function(i, r, s) {
                if (r) e("div.dtr-modal-content").empty().append(s());
                    ...
                    var o = function() {
                        ...
                        a = e('<div class="dtr-modal"/>').append(e('<div class="dtr-modal-display"/>').append(e('<div class="dtr-modal-content p-0"/>').append(s())).append(e('<div class="dtr-modal-close btn-close"></div>').click(function() {
                            o()
                ...
                t && t.header && e("div.dtr-modal-content").prepend('<div class="modal-header"><h4 class="modal-title">' + t.header(i) + "</h4></div>")
            }
        }
    };
    var o = {};
    ...
    function a(e, t, n) {
        var r = t + "-" + n;
        if (o[r]) {
            for (var s = e.cell(t, n).node(), a = o[r][0].parentNode.childNodes, d = [], l = 0, c = a.length; l < c; l++) d.push(a[l]);
            for (var u = 0, h = d.length; u < h; u++) s.appendChild(d[u]);
            o[r] = i
        }
    }
    s.renderer = {
                ...
                e.each(i, function(n, i) {
                    if (i.hidden) {
                        ...
                        e("<li " + a + ' data-dtr-index="' + i.columnIndex + '" data-dt-row="' + i.rowIndex + '" data-dt-column="' + i.columnIndex + '"><span class="dtr-title">' + i.title + "</span> </li>").append(e('<span class="dtr-data"/>').append(function(e, t, n) {
                            var i = t + "-" + n;
                            if (o[i]) return o[i];
                            for (var r = [], s = e.cell(t, n).node().childNodes, a = 0, d = s.length; a < d; a++) r.push(s[a]);
                            return o[i] = r, r
                        }(t, i.rowIndex, i.columnIndex))).appendTo(r), s = !0
                    }
                });
                return !!s && r
            }
        ...
        tableAll: function(t) {
            return t = e.extend({
                ...
                function(n, i, r) {
                    ...
                    return e('<table class="' + t.tableClass + ' dtr-details" width="100%"/>').append("<tbody>" + s + "</tbody>")
                }
        }
    }, s.defaults = {
    ...
    }), s.version = "2.2.5", e.fn.dataTable.Responsive = s, e.fn.DataTable.Responsive = s, e(n).on("preInit.dt.dtr", function(t, n, i) {
