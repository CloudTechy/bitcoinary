...
<template>
    <!-- <footer
        class="site-footer bg-no-repeat bg-full-height bg-center"
              ...
              <div class="col-md-6 col-sm-6">
                <div class="widget widget_about">
                  ...
                  <p>
                    ...
                    beneficial, brilliantly successful companies in the industry
                    of forex trading and investing.
                  </p>
                  <div
                    class="wt-icon-box-wraper left bdr-1 bdr-gray-dark p-tb15 p-lr10 clearfix"
                  >
                    <div class="icon-md text-primary">
                      <span class="fa fa-bitcoin fa-5x"></span>
                    </div>
                        ...
                        <ul>
                            ...
                            <li>
                                <a
                                    ...
                                    :href="
                                        $root.basepath +
                                        '/assets/documents/home/sec_doc.pdf'
                                    "
                                    target="_blank"
                                    style="color: #fff"
                                    >SEC Regulation</a
                            ...
                            <li>
                                <a
                                    ...
                                    :href="
                                        $root.basepath +
                                        '/assets/documents/home/whitepaper.pdf'
                                    "
                                    target="_blank"
                                    style="color: #fff"
                                    >White paper</a
                ...
                <div class="col-lg-3">
                    <div class="widget">
                        ...
                        <small style="line-height: 5px"
                            ...
                            updates and special offers in your inbox.</small
                        >
                    </div>
                </div>
            </div>
