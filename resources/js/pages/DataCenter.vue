                        ...
                        <div class="data-center-services">
                            ...
                            <div class="row">
                                <div class="column col dcs">
                                    ...
                                    <p> Bitcoinary Mint Limited‘s datacenters have a high connectivity network which enables smooth hash power for efficient mining of Bitcoins. No downtime due to highly available network, supports uninterrupted mining to go on.</p>
                                </div>
                                <div class="column col dcs">
