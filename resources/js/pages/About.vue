                ...
                <div class="row justify-content-center">
                        <div class="col-lg-7 col-md-12 text-center">
                            <div class="section-header">
                                <h2 class="section-title"><span class="font-weight-normal">About </span> <b class="base--color">Us</b></h2>
