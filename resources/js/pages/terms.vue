	...
	<section :data-background="$root.basepath + '/images/bg/bg-5.jpg'" class="bg_img pt-120 pb-120 border-top-1">
        <div class="container">
            ...
            <div id="terms" class="col-lg-12">
                <div class="blog-details-wrapper">
                    <div class="blog-details__content">
                        ...
                        <p class="text-justify">This user agreement (the Agreement) describes the terms and conditions of using the services provided by Bitcoinary Mint to the registered user (Client), including the access to the personal account and payment operations performed through the Bitcoinary Mint website located at Bitcoinary Mint.
								<br>Using Bitcoinary Mint services, you confirm that you have read this Agreement, understood its meaning in full and accept this Agreement.
								<br>All interested parties are required to read all that is written and stated on this page without skipping even a single word. This acts as the official and binding terms and conditions between You the registrant and our company Bitcoinary Mint.
								...
								<br>Upon registration, the user shall be called "member". All members of our company must oblige to follow all the rules written on this page. We stress this multiple times, as our company have very stringent rulings regarding the use of our website and that of our company program.
								<br>All registrants should be of legal ages and must reside in a country where participation in foreign investment programs is not prohibited. If you live within said conditions, then feel free to sign up without worries.
								<br>All registrants must use a valid e-mail address in order for us to be able to communicate properly when issues arise out of misuse or technical reasons.
								<br>When registering, you hold Bitcoinary Mint free from any liabilities and losses you may incur in the circumstances unforeseen, such as account compromise, suspension, and or deletion, due to reasons caused by the registrant.
								<br>Bitcoinary Mint services are not available to the general public and are opened only to the qualified members of Bitcoinary Mint, the use of this site is restricted to our members and to individuals personally invited by them. Every deposit is considered to be a private transaction between the Bitcoinary Mint and its Member.
            ...
            <div id="restrictions" class="col-lg-12">
                <div class="blog-details-wrapper">
                    <div class="blog-details__content">
                        <h4 class="blog-details__title">Restrictions</h4>
                        <p class="text-justify">You may not use the Services if you are located in, or a citizen or resident of any state, country, territory or other jurisdiction that is embargoed by the UNSC or where your use of the Services would be illegal or otherwise violate any applicable law. You represent and warrant that you are not a citizen or resident of any such jurisdiction and that you will not use any Services while located in any such jurisdiction. You also may not use the Services if you are located in, or a citizen or resident of, any other jurisdiction where Bitcoinary Mint has determined, at its discretion, to prohibit use of the Services (USA etc.). Bitcoinary Mint may implement controls to restrict access to the Services from any jurisdiction prohibited pursuant to this Section. You will comply with this Section, even if Bitcoinary Mint methods to prevent use of the Services are not effective or can be bypassed.
								...
								<br>- errors on the Site or with the Bitcoinary Mint Online Service caused by incomplete or incorrect information provided to us by you or a third party;
