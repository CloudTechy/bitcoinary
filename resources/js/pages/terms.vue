...
<template>
   ...
   <div id="top"></div>
   <!-- section begin -->
   <section aria-label="section" data-bgimage="url(assets/images/home/bg2.jpg) top" class="text-light" id="subheader">
   ...
   <!-- section close -->
   <section aria-label="section" id = "terms" data-bgcolor="var(--secondary_color)">
      <div class="container">
         <div class="row align-items-center">
            <div class="col-md-12 whited">
               <h3 class="orange">Terms of Use:</h3>
                   <p class="text-justify">This user agreement (the Agreement) describes the terms and conditions of using the services provided by <span>{{$root.appName}}</span> to the registered user (Client), including the access to the personal account and payment operations performed through the <span>{{$root.appName}}</span> website located at <span>{{$root.appName}}</span>.
                                ...
                                <br>When registering, you hold <span>{{$root.appName}}</span> free from any liabilities and losses you may incur in the circumstances unforeseen, such as account compromise, suspension, and or deletion, due to reasons caused by the registrant.
   ...
   <section aria-label="section" id = "restrictions" data-bgcolor="var(--secondary_color)">
      <div class="container">
         <div class="row align-items-center">
            <div class="col-md-12 whited">
               <h3 class="orange">Restrictions:</h3>
   ...
   <section aria-label="section" id = "privacy-policy" data-bgcolor="var(--secondary_color)">
      <div class="container">
         <div class="row align-items-center">
            <div class="col-md-12 whited">
               <h3 class="orange">Privacy Policy:</h3>
