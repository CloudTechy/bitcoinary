...
<template>
    <div class="page-wraper">
        ...
        <div class="no-bottom no-top" id="content">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-5 wow fadeInRight" data-wow-delay=".0s">
                            ...
                            <p class="lead">
                                Earn by investing in the rapidly growing
                                crypto market. Our team of experts are
                                dedicated to creating a unique & profitable
                                investment opportunity for you.<br />
                                <span style="color: #ffcc29">Get a free simple, secure,
                                    industry-standard and elite wallet to
                                    keep your assets safe, based on over 10
                                    million users globally.</span>
                            </p>
                            <div class="spacer-20"></div>
                            <a class="btn-custom" href="/register" style="
                        ...
                        <div class="col-lg-6 offset-lg-1 text-center wow fadeInLeft" data-wow-delay=".5s" style="
                                    padding-top: 100px;
                            ...
                            <div class="f-box f-icon-left f-icon-circle f-icon-shadow">
                                ...
                                <div class="fb-text">
                                    <p class="whited" style="color: white">
                                        Create your own account to get
                                        started. It takes a few minutes to
                                        complete registration.
                                    </p>
                                    <a href="/register" class="btn-border text-white">Sign Up</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 mb30 sq-item wow">
                            <div class="f-box f-icon-left f-icon-circle f-icon-shadow">
                                ...
                                <div class="fb-text">
                                    ...
                                    <a href="/" class="btn-border text-white">Invest Funds</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 mb30 sq-item wow">
                            <div class="f-box f-icon-left f-icon-circle f-icon-shadow">
                                ...
                                <div class="fb-text">
                                    <p class="whited" style="color: white">
                                        Now you are all setup and ready to
                                        start earning and withdraw without
                                        hassle.
                                    </p>
                                    <a href="/" class="btn-border text-white">Withdraw Profit</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section id="section-banner" data-bgcolor="var(--secondary_color)" class="profile">
                <div class="container" id="about">
                    <div class="row align-items-center">
                        <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0s">
                            <h2 style="color: #fff">Corporate Profile</h2>
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active whited" id="pills-home" role="tabpanel"
                                    ...
                                    <div class="field field--name-field-nir-global-block-body field--type-text-long field--label-hidden field__item"
                                        ...
                                        <p>
                                            ...
                                            infrastructure for the mining of
                                            Bitcoin.
                                        </p>

                                        <p>
                                            We believe it is increasingly
                                            vital that Bitcoin is, and can
                                            be, mined and utilized in an
                                            environmentally and socially
                                            responsible manner. We are
                                            focused on locating our
                                            operations in areas with
                                            low-cost and excess renewable
                                            energy.
                                        </p>

                                        <p>
                                            We are building proprietary data
                                            centers that continue to be
                                            refined through years of
                                            research and development to
                                            optimize the operational
                                            environment and efficiencies,
                                            including stable uptime
                                            performance during high and
            ...
            <!-- section close -->
            <section aria-label="section" data-bgimage="url(assets/images/home/hp.jpg) top" class="text-light"
                id="whyUs">
                <div class="container">
                    <div class="text-center">
                        <span class="p-title" style="background-color: #fff">Discover</span><br />
                        ...
                        <div class="col-lg-4 col-md-6 mb30 sq-item wow">
                            <div class="f-box f-icon-left f-icon-circle f-icon-shadow">
                                ...
                                <div class="fb-text">
                                    ...
                                    <p class="whited" style="color: white">
                                        Our Plans & our earnings at the
                                        mining & trading sector of the
                                        business apply to all, we make sure
                                        that our expenses & revenue are
                                        balanced to keep us running.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 mb30 sq-item wow">
                            <div class="f-box f-icon-left f-icon-circle f-icon-shadow">
                                ...
                                <div class="fb-text">
                                    ...
                                    <p class="whited" style="color: white">
                                        We have enforced SSL encryption on
                                        all dynamic response pages to secure
                            ...
                            <div class="f-box f-icon-left f-icon-circle f-icon-shadow">
                                ...
                                <div class="fb-text">
                                    ...
                                    <p class="whited" style="color: white">
                                        ...
                                        moment by requesting. The funds will
                                        be sent to your crypto-wallet
                                        instantly.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb30 sq-item wow">
                            <div class="f-box f-icon-left f-icon-circle f-icon-shadow">
                                ...
                                <div class="fb-text">
                                    ...
                                    <p class="whited" style="color: white">
                                        Our company conducts absolutely
                                        legal activities in the legal field.
                                        We are certified to operate
                                        investment business, we are legal
                                        and safe.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="f-box f-icon-left f-icon-circle f-icon-shadow">
                                ...
                                <div class="fb-text">
                                    ...
                                    <p class="whited" style="color: white">
                                        ...
                                        people. We are working hard
                                        constantly to improve the level of
                                        our security system and minimize
                                        possible risks.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb30 sq-item wow">
                            <div class="f-box f-icon-left f-icon-circle f-icon-shadow">
                                ...
                                <div class="fb-text">
                                    ...
                                    <p class="whited" style="color: white">
                                        Anonymity and using cryptocurrency
                                        as a payment instrument. In the era
                                        of electronic money – this is one of
                                        the most convenient ways of
                                        cooperation.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="f-box f-icon-left f-icon-circle f-icon-shadow">
                                ...
                                <div class="fb-text">
                                    ...
                                    <p class="whited" style="color: white">
                                        ...
                                        spontaneously once requested. There
                                        are high maximum limits. The minimum
                        ...
                        <div class="col-lg-4 col-md-6 mb30 sq-item wow">
                            <div class="f-box f-icon-left f-icon-circle f-icon-shadow">
                                ...
                                <div class="fb-text">
                                    ...
                                    <p class="whited" style="color: white">
                                        We think investing is better with
                                        family and friends, so for everyone
                                        you invite to join, you’ll both earn
                                        reward crypto assets.
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="f-box f-icon-left f-icon-circle f-icon-shadow">
                                ...
                                <div class="fb-text">
                                    ...
                                    <p class="whited" style="color: white">
                                        ...
                                        through e-mail and telegram. Our
                                        support representatives are
                                        periodically available to elucidate
                                        any difficulty.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb30 sq-item wow">
                            <div class="f-box f-icon-left f-icon-circle f-icon-shadow">
                                ...
                                <div class="fb-text">
                                    ...
                                    <p class="whited" style="color: white">
                                        We are using a dedicated server for
                                        the website which allows us
                                        exclusive use of the resources of
                                        the entire server.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb30 sq-item wow">
                            <div class="f-box f-icon-left f-icon-circle f-icon-shadow">
                                ...
                                <div class="fb-text">
                                    ...
                                    <p class="whited" style="color: white">
                                        Comodo Essential-SSL Security
                                        encryption confirms that the
                                        presented content is genuine and
                                        legitimate.
                                    </p>
                                </div>
                            </div>
            ...
            <section aria-label="section" data-bgimage="url(assets/images/home/sl-home2-img1.jpg) top"
                class="text-light" id="affiliate">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-6 text-center wow fadeInLeft" data-wow-delay="0s" style="margin: auto 0px">
                            <br /><br />
                            <img :src="$root.basepath + '/assets/images/home/mobile.png'" class="img-fluid" alt=""
                                style="width: 60%" />
                        </div>
                        <div class="col-md-6 col-sm-12 wow fadeInRight" data-wow-delay="0s">
                            ...
                            <p style="color: #fff">
                                ...
                                and friends, so for everyone you invite to
                                join, you’ll both earn reward crypto assets.
                                As soon as your friend signs up and Makes a
                                first deposit , we’ll credit each of your
                                accounts with a reward Crypto Assets. Keep
                                in mind: You can receive up to $500 in
                                reward crypto assets each calendar year, so
                            ...
                            <a class="btn-custom" href="/register" style="
                                        ...
                                        color: #000;
                                    ">Sign Up</a>&nbsp;
                            <a class="btn-border" href="/login" style="
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <p class="whited">
                                Kindly contact us with any of the means
                                below & we will get back to you as soon as
                                possible
                            </p>
                            <div class="padding40 box-rounded mb30" data-bgcolor="#c94747">
                                <h3>Our Office</h3>
                                <address class="s1">
                                    <span><i class="id-color fa fa-map-marker fa-lg"></i>220 W Exchange St, Providence,
                                        RI
                                        02903</span>
                            ...
                            <form name="contactForm" id="contact_form" class="form-border" method="post" action="">
                                <div class="field-set">
                                    <input type="text" name="name" id="name" class="form-control"
                                        placeholder="Your Name" style="background-color: #f0f4fd" />
                                </div>
                                <div class="field-set">
                                    <input type="text" name="email" id="email" class="form-control"
                                        placeholder="Your Email" style="background-color: #f0f4fd" />
                                </div>
                                <div class="field-set">
                                    <input type="text" name="phone" id="phone" class="form-control"
                                        placeholder="Your Phone" style="background-color: #f0f4fd" />
                                </div>
                                <div class="field-set">
                                    <textarea name="message" id="message" class="form-control"
                                        placeholder="Your Message" style="background-color: #f0f4fd"></textarea>
                                </div>
                                <div class="spacer-half"></div>
                                <div id="submit">
                                ...
                                <div id="mail_fail" class="error">
                                    Sorry, error occured this time sending
                                    your message.
                                </div>
                            </form>
                        </div>
                            ...
                            <div id="accordion-1" class="accordion">
                                ...
                                <div class="card">
                                    <div id="heading-a1" class="card-header bg-white shadow-sm border-0">
                                        <h6 class="mb-0 font-weight-bold">
                                            <a href="#" data-toggle="collapse" data-target="#collapse-a1"
                                                aria-expanded="false" aria-controls="collapse-a1"
                                                class="d-block position-relative text-dark collapsible-link py-2">How do
                                                I make profit from
                                                cryptocurrency
                                                investment?</a>
                                        </h6>
                                    ...
                                    <div id="collapse-a1" aria-labelledby="heading-a1" data-parent="#accordion-1"
                                        ...
                                        <div class="card-body p-4">
                                            <p class="m-0">
                                                A: The profit on investment
                                                is the interest earned which
                                                is paid periodically.
                                                Interest on investment is
                                                paid monthly, quarterly or
                                                at maturity of the
                                                investment. You have the
                                                option of reinvesting your
                                                accrued interest or
                                                receiving (same as) a direct
                                                credit into your Wallet.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div id="heading-a2" class="card-header bg-white shadow-sm border-0">
                                        <h6 class="mb-0 font-weight-bold">
                                            <a href="#" data-toggle="collapse" data-target="#collapse-a2"
                                ...
                                <div class="card">
                                    <div id="heading-a3" class="card-header bg-white shadow-sm border-0">
                                        <h6 class="mb-0 font-weight-bold">
                                            <a href="#" data-toggle="collapse" data-target="#collapse-a3"
                                    ...
                                    <div id="collapse-a3" aria-labelledby="heading-a3" data-parent="#accordion-1"
                                        ...
                                        <div class="card-body p-4">
                                            <p class="m-0">
                                                ...
                                                Commission (SEC) and
                                                Financial Industry
                                                Regulatory Authority. West
                                                Exchangeowns a very strong
                                                capital base and a robust
                                                risk management framework
                                                that ensures your investment
                                                is in safe hands.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div id="heading-a4" class="card-header bg-white shadow-sm border-0">
                                        <h6 class="mb-0 font-weight-bold">
                                            <a href="#" data-toggle="collapse" data-target="#collapse-a4"
                                                aria-expanded="false" aria-controls="collapse-a4"
                                                class="d-block position-relative collapsed text-dark collapsible-link py-2">What
                                                will I receive as
                                                proof of my investment</a>
                                        </h6>
                                    </div>
                                    <div id="collapse-a4" aria-labelledby="heading-a4" data-parent="#accordion-1"
                                        class="collapse">
                                        <div class="card-body p-4">
                                            <p class="m-0">
                                ...
                                <div class="card">
                                    <div id="heading-b5" class="card-header bg-white shadow-sm border-0">
                                        <h6 class="mb-0 font-weight-bold">
                                            <a href="#" data-toggle="collapse" data-target="#collapse-b5"
                                                aria-expanded="false" aria-controls="collapse-b5"
                                                class="d-block position-relative collapsed text-dark collapsible-link py-2">Can
                                                I invest in multiple
                                                investment products?
                                            </a>
                                        </h6>
                                    </div>
                                    <div id="collapse-b5" aria-labelledby="heading-b4" data-parent="#accordion-2"
                                        class="collapse">
                                        <div class="card-body p-4">
                                            <p class="m-0">
                                                A: Yes, you can. Most
                                                ...
                                                objective. Thus, you can
                                                invest in several of our
                                ...
                                <div class="card">
                                    <div id="heading-b6" class="card-header bg-white shadow-sm border-0">
                                        <h6 class="mb-0 font-weight-bold">
                                            <a href="#" data-toggle="collapse" data-target="#collapse-b6"
                                                aria-expanded="false" aria-controls="collapse-b6"
                                                class="d-block position-relative collapsed text-dark collapsible-link py-2">What
                                                is the maximum number
                                                of people in a group who can
                                                invest in this scheme?
                                            </a>
                                        </h6>
                                    </div>
                                    <div id="collapse-b6" aria-labelledby="heading-b4" data-parent="#accordion-2"
                                        class="collapse">
                                        <div class="card-body p-4">
                                            <p class="m-0">
                                                A: There is no cap to the
                                                number of people who can
                                                make up a group to invest in
                                                the scheme.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div id="heading-b7" class="card-header bg-white shadow-sm border-0">
                                        <h6 class="mb-0 font-weight-bold">
                                            <a href="#" data-toggle="collapse" data-target="#collapse-b7"
                                                aria-expanded="false" aria-controls="collapse-b7"
                                                class="d-block position-relative collapsed text-dark collapsible-link py-2">Can
                                                I invest with what
                                                currencies?
                                            </a>
                                    ...
                                    <div id="collapse-b7" aria-labelledby="heading-b4" data-parent="#accordion-2"
                                        class="collapse">
                                        <div class="card-body p-4">
                                            <p class="m-0">
                                                A: Yes, you can invest with
                                                crypto currencies like
                                                Bitcoins ( BTC ), Ethereum (
                                                ETH ), Binance coin ( BNB
                                                ),Tether USD ( USDT ) ,
                                                Cardano ( ADA ) .
                                            </p>
                                        </div>
                            ...
                            <div id="accordion-2" class="accordion">
                                ...
                                <div class="card">
                                    <div id="heading-b8" class="card-header bg-white shadow-sm border-0">
                                        <h6 class="mb-0 font-weight-bold">
                                            <a href="#" data-toggle="collapse" data-target="#collapse-b8"
                                                aria-expanded="false" aria-controls="collapse-b8"
                                                class="d-block position-relative text-dark collapsible-link py-2">How
                                                can I keep track of my
                                                investment?</a>
                                        </h6>
                                    </div>
                                    <div id="collapse-b8" aria-labelledby="heading-b1" data-parent="#accordion-2"
                                        class="collapse">
                                        <div class="card-body p-4">
                                            <p class="m-0">
                                                A: Once you’ve signed on as
                                                a client, you will be given
                                                access to view and monitor
                                                your account activity
                                                online. You may also request
                                ...
                                <div class="card">
                                    <div id="heading-b9" class="card-header bg-white shadow-sm border-0">
                                        <h6 class="mb-0 font-weight-bold">
                                            <a href="#" data-toggle="collapse" data-target="#collapse-b9"
                                                aria-expanded="false" aria-controls="collapse-b9"
                                                class="d-block position-relative collapsed text-dark collapsible-link py-2">Can
                                                I invest for my
                                                children?</a>
                                        </h6>
                                    </div>
                                    <div id="collapse-b9" aria-labelledby="heading-b2" data-parent="#accordion-2"
                                        class="collapse">
                                        <div class="card-body p-4">
                                            <p class="m-0">
                                                A: Yes, you can.
                                ...
                                <div class="card">
                                    <div id="heading-b10" class="card-header bg-white shadow-sm border-0">
                                        <h6 class="mb-0 font-weight-bold">
                                            <a href="#" data-toggle="collapse" data-target="#collapse-b10"
                                                aria-expanded="false" aria-controls="collapse-b10"
                                                class="d-block position-relative collapsed text-dark collapsible-link py-2">How
                                    ...
                                    <div id="collapse-b10" aria-labelledby="heading-b3" data-parent="#accordion-2"
                                        class="collapse">
                                        <div class="card-body p-4">
                                            <p class="m-0">
                                                A: Withdrawal of fund is
                                                processed on the same
                                                working day your request is
                                                received provided your
                                                request is received during
                                ...
                                <div class="card">
                                    <div id="heading-b11" class="card-header bg-white shadow-sm border-0">
                                        <h6 class="mb-0 font-weight-bold">
                                            <a href="#" data-toggle="collapse" data-target="#collapse-b11"
                                                aria-expanded="false" aria-controls="collapse-b11"
                                                class="d-block position-relative collapsed text-dark collapsible-link py-2">Can
                                                I invest from any part
                                                of the world?
                                            </a>
                                        </h6>
                                    </div>
                                    <div id="collapse-b11" aria-labelledby="heading-b4" data-parent="#accordion-2"
                                        class="collapse">
                                        <div class="card-body p-4">
                                            <p class="m-0">
                                                A: Yes, you can. Our robust
                                                platform allows you to
                                                invest from any part of the
                                                world by opening an account
                                                online.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div id="heading-b12" class="card-header bg-white shadow-sm border-0">
                                        <h6 class="mb-0 font-weight-bold">
                                            <a href="#" data-toggle="collapse" data-target="#collapse-b12"
                                                aria-expanded="false" aria-controls="collapse-b12"
                                                class="d-block position-relative collapsed text-dark collapsible-link py-2">Can
                                                I add to my investment
                                                at any time?
                                            </a>
                                        </h6>
                                    </div>
                                    <div id="collapse-b12" aria-labelledby="heading-b4" data-parent="#accordion-2"
                                        class="collapse">
                                        <div class="card-body p-4">
                                            <p class="m-0">
                                                A: Yes, you can. Our
                                                platform allows you to top
                                                up your investment at any
                                                time.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div id="heading-b13" class="card-header bg-white shadow-sm border-0">
                                        <h6 class="mb-0 font-weight-bold">
                                            <a href="#" data-toggle="collapse" data-target="#collapse-b13"
                                                aria-expanded="false" aria-controls="collapse-b13"
                                                class="d-block position-relative collapsed text-dark collapsible-link py-2">Can
                                                I have multiple
                                                investment accounts running?
                                            </a>
                                        </h6>
                                    </div>
                                    <div id="collapse-b13" aria-labelledby="heading-b4" data-parent="#accordion-2"
                                        class="collapse">
                                        <div class="card-body p-4">
                                            <p class="m-0">
                                                A: Yes, you can. As long as
                                                these accounts are in your
                                                name or minors’ whose
                                                identity are linked to your
                                                Email
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div id="heading-b14" class="card-header bg-white shadow-sm border-0">
                                        <h6 class="mb-0 font-weight-bold">
                                            <a href="#" data-toggle="collapse" data-target="#collapse-b14"
                                                aria-expanded="false" aria-controls="collapse-b14"
                                                class="d-block position-relative collapsed text-dark collapsible-link py-2">Can
                                                I transfer my
                                                investments from me to
                                                someone else?
                                            </a>
                                        </h6>
                                    </div>
                                    <div id="collapse-b14" aria-labelledby="heading-b4" data-parent="#accordion-2"
                                        class="collapse">
                                        <div class="card-body p-4">
                                            <p class="m-0">
                                                A: Yes, you can. All you
                                                need to do is send a duly
                                                signed instruction to that
                                                effect.
                                            </p>
                                        </div>
                                    </div>
