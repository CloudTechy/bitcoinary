    ...
    <div class="row mt-2">
        <div  v-if = "referrals.length > 0" class="card p-2">
            <small class="text-center mobile">Click the <span class="text-white"
                    style="padding:2px 7px;border-radius:50%;background-color:#0d6efd">+</span> icon for details</small>
            <hr>
            <div id="example_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table id="example"
                            class="table table-striped table-bordered dt-responsive nowrap table-condensed dataTable no-footer dtr-inline"
                            aria-describedby="example_info" style="width: 973px;">
                            <thead class="text-primary">
        
                                <tr>
                                    <th class="text-primary sorting sorting_desc" tabindex="0" aria-controls="example"
                                        rowspan="1" colspan="1" style="width: 365px;" aria-sort="descending"
                                        aria-label="Date Registered: activate to sort column ascending">Date Registered</th>
                                    <th class="text-primary sorting" tabindex="0" aria-controls="example" rowspan="1"
                                        colspan="1" style="width: 185px;" aria-label="Name: activate to sort column ascending">
                                        Name</th>
                                    <th class="text-primary sorting" tabindex="0" aria-controls="example" rowspan="1"
                                        colspan="1" style="width: 293px;" aria-label="Email: activate to sort column ascending">
                                        Email</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr class="odd">
                                    <td class="dtr-control sorting_1" tabindex="0"><span style="display:none">11/12/2022
                                            03:41</span>12th November, 2022 03:41 AM</td>
                                    <td>Guns N Petalss</td>
                                    <td>conyekelu@yahoo.com</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <div class="dataTables_paginate paging_simple_numbers" id="example_paginate">
                            <ul class="pagination">
                                <li class="paginate_button page-item previous disabled" id="example_previous"><a href="#"
                                        aria-controls="example" data-dt-idx="0" tabindex="0" class="page-link">Previous</a></li>
                                ...
                                <li class="paginate_button page-item next disabled" id="example_next"><a href="#"
                                        aria-controls="example" data-dt-idx="2" tabindex="0" class="page-link">Next</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        getReferrals() {
            ...
            var form = new Form()
            form.get("auth/user/referrals/" + this.$auth.user().id)
                .then(response => {
