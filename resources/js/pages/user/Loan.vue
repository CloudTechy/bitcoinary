            ...
            <div class="card-body">
                ...
                <form method="post" @submit.prevent="loanRequest" style="width: 100%">
                    <div class="form-group basic">
                        ...
                        <p v-if="errors.occupation" v-for="error in errors.occupation" class="text-danger m-0 p-1 pt-0 small">
                            {{ error }}
                        </p>
                    </div>
                    ...
                    <div class="form-group basic">
                        ...
                        <div class="form-group basic">
                            ...
                            <p v-if="errors.tenor" v-for="error in errors.tenor" class="text-danger m-0 p-1 pt-0 small">
                                {{ error }}
                            </p>
                        </div>
                    ...
                    <div class="form-group basic">
                        ...
                        <p v-if="errors.purpose" v-for="error in errors.purpose" class="text-danger m-0 p-1 pt-0 small">
                            {{ error }}
                        </p>
                    </div>
                    <div class="form-group basic">
