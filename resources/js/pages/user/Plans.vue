                            ...
                            <div class="card-body">
                                ...
                                <form method="post" @submit.prevent="withdraw">
                                    ...
                                    <div class="form-group basic">
                                        ...
                                        <div class="input-group mb-2">
                                            <select class="form-control p-1" v-model="withdrawalPaymentMethod" required>
                                    ...
                                    <div class="form-group basic">
                                        ...
                                        <div class="input-wrapper mb-2">
                                            <input type="text" readonly v-model="wallet" class="form-control" required>
                                            <small
                                    ...
                                    <div class="form-group basic">
                                        ...
                                        <div class="input-group mb-2">
                                            <input type="number" v-model="withdrawalForm.amount" class="form-control"
                                                min="1" :max="$auth.user().balance" required>
                                    ...
                                    <div class="form-group basic text-center">
                                        <button ref="submitWithdrawalForm" type="submit" class="btn btn-info">Withdraw
                                        </button>
                                    </div>
                    ...
                    <div v-else class="modal-body m-1">
                        ...
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                ...
                                <input type="text" placeholder="Enter address" v-model="walletForm.acc_number" :class="{
                                    'form-control': true,
                                    'fontsize-sub':true,
                                    'fontsize-sub':true,
                                    'error-input':
