            ...
            <div class="bodywrapper__inner">
                ...
                >
                    <div class="col-lg-6 col-sm-6">
                        <h6 class="page-title">Update Plan</h6>
                    </div>
...
export default {
    ...
    watch: {
        package() {
            this.form.fill(this.package);
            this.form.turnover = this.package.duration
        },
    },
    created() {this.fetchPackage(this.$route.params.id);},
    components: {
        VueLoadingButton,ContentLoader, ListLoader
    },
    mounted() {
    ...
    methods: {
        addPackage() {
            ...
            this.form
                .patch("/auth/packages/" + this.package.id)
				.then((response) => {
                    this.loading = false;
