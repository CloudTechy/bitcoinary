                                ...
                                <div class="p-3 bg--white">
                                    <div class="">
                                        ...
                                        :src="
                                                                    $root.basepath +
                                                                    '/images/uploads/' +
                                                                    cryptoFilter($root.payments, deposit.payment_method)[0].image
                                                                "
                                            alt="profile-image"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        ...
                                        <p v-if = "deposit.transaction_ref">{{deposit.transaction_ref}}</p>
                                        <p v-else> NIL</p>
                                    </div>
                                </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form
                                action=""
                                method="POST"
                                @submit.prevent = "approveTransaction(deposit.id)"
                            >
