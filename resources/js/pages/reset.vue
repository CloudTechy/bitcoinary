    ...
    <div class="main">
        <h1>
            <div class="sitelogo" style="background: rgba(1, 0, 21, 0.66); padding: 15px 0 5px">
                <a href="/"><img :src='$root.basepath +"/assets/images/logo2.png"' width="230" height=""
                        alt="site logo" /></a>
            </div>
        </h1>
        <div class="w3_agile_main_grids">

            <form autocomplete="off" @submit.prevent="resetPassword" class="agile_form" method="post">
                <div class="form-group">
                    <ul class="alert alert-danger " v-if="errors.error">
                        ...
                        <li>
                            <p v-if="errors.error.error && typeof errors.error.error == 'string' "
                                class="text-center p-1 m-lg-3 m-sm-1">{{errors.message || errors.error.error}}</p>
                        </li>
                    </ul>
                    <div class="alert alert-success" v-if="success && !has_error">
                        <p class="p-2 m-lg-3 m-sm-1" v-if="response != undefined">{{response.message}}<span><a
                                    class="base--color" href="/login">login</a></span></p>
                    </div>
                </div>
                    ...
                    <div class="col-md-12 col-sm-12 form-group">
                        <div class="wthree_input">
                            ...
                            <input type="password" id="password_confirmation" class="form-control"
                                placeholder="Renter new password" v-model="password_confirmation" required>
                ...
                <div class="card">
                    <div class="card-body pb-1">
                        ...
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                <a href="/forgot_password" class="text-primary">Need some help?</a> | <a href="/register"
                ...
                <div class="row form-group">
                    <div class="col-md-12 col-sm-12">
                        <button type="submit" ref="process" class="btn btn-primary"
            ...
            <div class="mt-5 agileits_copyright">
                <span class="copyrights-text text-white">© {{$root.fullYearTemplate}}
                    <a href="/" class="base--color">{{ company }}</a>. All rights reserved</span>
            </div>
        </div>
    </div>
</template>
